...
$(function () {
    QUnit.test('Hangul.disassemble Tests', function (assert) {
        assert.deepEqual(
        ...
        assert.throws(
            function () {
                Hangul.disassemble(null);
            },
            function (err) {
                return err.message === 'Arguments cannot be null';
            },
            'Hangul.disassemble(null) must raise an exception.'
        );
    });

    QUnit.test('Hangul.assemble Tests', function (assert) {
        assert.equal(
    ...
    QUnit.test('Hangul.search Tests', function (assert) {
        assert.equal(
    ...
    QUnit.test('Hangul.assemble and Hangul.disassemble on all Hangul characters', function (assert) {
        assert.equal(
            ...
            11172,
            "The number of valid characters in Hangul is 11172"
        );
    ...
    QUnit.test('Grouped flag', function (assert) {
        assert.deepEqual(
    ...
    QUnit.test('rangeSearch() tests', function (assert) {
        var text = '간장공장공장장';
