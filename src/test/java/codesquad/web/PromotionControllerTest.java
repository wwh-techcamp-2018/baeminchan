...
//
//    @Test
//    public void 프로모션_등록_성공() {
//        PromotionDto promotionDto = new PromotionDto("첫번째 타이틀", 1, LocalDate.of(2018, 1, 2), LocalDate.of(2019, 1, 2), "/img/01");
//        ResponseEntity<Promotion> response = basicAuthTemplate(defaultUser).postForEntity("/api/promotions", promotionDto, Promotion.class);
//        assertThat(response.getBody().getTitle()).isEqualTo("첫번째 타이틀");
//    }
